...
function GetLoginData(email, password) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const LoggedInMessage = `You are now Logged In \n Username: ${chalk_1.default.green(response.data.userLogin.name)} \n Email: ${chalk_1.default.green(response.data.userLogin.email)}`;
            console.log(LoggedInMessage);
            fs_1.default.writeFileSync(filePath, JSON.stringify(response.data));
